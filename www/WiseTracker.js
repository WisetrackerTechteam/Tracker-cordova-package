...
exports.setProduct = function(key, value, success, error) {
    exec(success, error, "WiseTrackerBridge", "setProduct", [key, value]);
}

exports.setContents = function(value, success, error) {
    exec(success, error, "WiseTrackerBridge", "setContents", [value]);
}
